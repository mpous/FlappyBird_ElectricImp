...
else
{
  ...
  setInterval(screenClickEI, 500);
}


function getTilt()
{
    // Introduce the URL from your Electric Imp AGENT here
    var url = "https://agent.electricimp.com/XZZ2usEpIykk.json";
